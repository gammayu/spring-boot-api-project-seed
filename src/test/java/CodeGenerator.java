...
public class CodeGenerator {
    ...
    private static final String PROJECT_PATH = System.getProperty("user.dir") + "\\springbtseed";//项目在硬盘上的基础路径
    ...
    private static final String AUTHOR = "liuyu";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    public static void main(String[] args) {
//        genCode("输入表名");
        genCode("tb_country");
//        System.out.println(CodeGenerator.class.getClass().getResource("/").getPath());
